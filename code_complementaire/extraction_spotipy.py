...
#Crée 2 listes avec les noms et les ID de toutes les playlists de l'utilisateur (privées et publiques)
...
#Utilise la première recommandation pour retourner un dataframe des morceaux recommandés
